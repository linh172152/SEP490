...
export default function FamilyExerciseScriptDetailPage() {
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-3xl border border-slate-200/80 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950">
                  ...
                  <div className="mt-2 text-3xl font-bold text-slate-900 dark:text-slate-100">{script.durationMinutes} min</div>
                </div>
                <div className="rounded-3xl border border-slate-200/80 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950">
              ...
              <div className="flex justify-end">
                <Button onClick={() => router.push('/dashboard/family/exercises')}>
