...
export function ExerciseLibrary() {
  ...
  const fetchScripts = async () => {
    try {
      ...
      toast.error(t("common.error"), {
        description: "Could not load exercise library.",
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const handleCreate = async (data: ExerciseScriptRequest) => {
    try {
      ...
      toast.success(t("common.success"), {
        description: "Exercise script created successfully.",
      });
  ...
  const handleUpdate = async (data: ExerciseScriptRequest) => {
    ...
    try {
      ...
      toast.success(t("common.success"), {
        description: "Exercise script updated successfully.",
      });
      setIsModalOpen(false);
      fetchScripts();
    } catch (error) {
      toast.error(t("common.error"), {
        description: "Failed to update exercise script.",
      });
    } finally {
      setIsSubmitting(false);
    }
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      toast.success(t("common.success"), {
        description: "Exercise script deleted.",
      });
      fetchScripts();
    } catch (error) {
      toast.error(t("common.error"), {
        description: "Failed to delete exercise script.",
      });
    }
  };
