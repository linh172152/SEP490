        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left flex flex-col justify-center">
            ...
            <motion.div 
              ...
              className="mt-14 grid grid-cols-2 gap-y-8 sm:grid-cols-3 mx-auto lg:mx-0 max-w-lg lg:max-w-none items-start"
            >
              <div className="flex flex-col items-center lg:items-start gap-2 text-muted-foreground">
                <Cpu className="h-8 w-8 text-primary/70" />
                <span className="text-sm font-medium text-center lg:text-left">Predictive AI Monitoring</span>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-2 text-muted-foreground">
                <HeartPulse className="h-8 w-8 text-primary/70" />
                <span className="text-sm font-medium text-center lg:text-left">Real-time Emotion Sensing</span>
              </div>
              <div className="col-span-2 sm:col-span-1 flex flex-col items-center lg:items-start gap-2 text-muted-foreground">
                <ShieldCheck className="h-8 w-8 text-primary/70" />
                <span className="text-sm font-medium text-center lg:text-left">HIPAA Compliant Security</span>
              </div>
            </motion.div>
          </div>
